namespace EmployeeWage
{
    public class CompanyWiseWage
    {
        ...
        public CompanyWiseWage(string companyName, byte workHoursFullDay, byte workHoursPartDay, byte workHoursPerMonth, byte workDaysPerMonth, int employeeWagePerHour)
        {
